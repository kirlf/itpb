...
Противоположностью ACID можно назвать архитектуру [BASE](https://ru.wikipedia.org/wiki/%D0%A2%D0%B5%D0%BE%D1%80%D0%B5%D0%BC%D0%B0_CAP#BASE-%D0%B0%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%B0), которая используется, например, в NoSQL базах данных (см. подробнее Силен, Д., Мейсман, А. and Али, М., 2017. Основы Data Science и Big Data. Python и наука о данных. СПб.: Питер, - c. 190-192). Хотя и это не строгое правило (см. [Разбираем ACID по буквам в NoSQL (habr.com)](https://habr.com/ru/post/228327/)). И это уже совсем другая история...

## Полезные ссылки:
1. [Заметки о SQL и реляционной алгебре (habr.com)](https://habr.com/ru/post/275251/)
2. [Статья с задачками по SQL на примере Oracle (habr.com)](https://habr.com/ru/post/461567/)
