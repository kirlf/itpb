...
Ключевым словом для объявления структур является ```struct```; далее следуют ярлык (то есть название структуры); в фигурных скобках описываются входящие в структуру переменные; после по желанию можно объявить структурные переменные; заканчиваться конструкция должна обязательно точкой с запятой. 

Допустим, мы хотим описать точку в декартовом пространстве:
...
Обратиться к полям структуры можно напрямую через знак точки:
...
Кстати, структуры - это основа для многих не входящих в базовые типы данных.
