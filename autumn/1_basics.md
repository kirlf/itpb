...
Если цикл ```for``` нужно прервать при наступлении какого-то условия используют оператор  **break**. Если при наступлении какого-то условия нужно перейти на следующую итерацию, то используют оператор **continue** (см. [Керниган, Ричи]: "3.7 Операторы break и continue").
