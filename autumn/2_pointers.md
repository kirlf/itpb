...
## Память: автоматическая, статическая, дмнамическая

Оперируя с переменными и функциями, вы неизбежно взаимодействуете с памятью ЭВМ, даже если об этом не задумываетесь. Задавая переменные внутри функций или же вызывая другие функции, ЭВМ **автоматически** выделяет в опеределенном участке организованной в виде **стека** памяти нужное количество байт и так же автоматически очищает данный участок памяти, когда функции заканчивают свою работу. Размер такого стека, как правило, равен примерно 2-3 мегабайтам.
